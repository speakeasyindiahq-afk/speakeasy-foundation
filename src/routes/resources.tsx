...
export const Route = createFileRoute("/resources")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://speakeasyindia.online/resources" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Resources & Helplines — Speakeasy India" },
      { name: "twitter:description", content: "Crisis helplines, sexual health support, LGBTQIA+ resources, and abuse support across India." },
    ],
    links: [{ rel: "canonical", href: "https://speakeasyindia.online/resources" }],
  }),
