...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://speakeasyindia.online/contact" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Contact — Speakeasy India" },
      { name: "twitter:description", content: "Reach Speakeasy India for general, press, expert collaboration, or privacy questions." },
    ],
    links: [{ rel: "canonical", href: "https://speakeasyindia.online/contact" }],
  }),
