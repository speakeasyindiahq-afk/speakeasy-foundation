...
export const Route = createFileRoute("/privacy")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://speakeasyindia.online/privacy" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Privacy — Speakeasy India" },
      { name: "twitter:description", content: "Plain-language privacy practices. What we collect, what we don't, and how to request data deletion." },
    ],
    links: [{ rel: "canonical", href: "https://speakeasyindia.online/privacy" }],
  }),
