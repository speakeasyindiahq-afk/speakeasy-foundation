...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Playfair+Display:wght@500;600;700&family=Inter:wght@400;500;600;700&family=Hind:wght@400;500;600;700&display=swap",
      },
      {
        rel: "stylesheet",
        href: appCss,
  ...
  return (
    <html lang="en">
      <head>
        ...
        <script
          async
          src="https://www.googletagmanager.com/gtag/js?id=G-7MGLBWFR3G"
        />
        <script
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `
              ...
              })(window, document, "clarity", "script", "wzmd5rvx8n");
            `,
          }}
        />
      </head>
