...
import { LayoutDashboard, Home, BookOpen, AlertCircle, Headphones, MessageSquare, Shield, Search, LogOut, Gauge, Settings } from "lucide-react";
...
const sections = [
  ...
  { to: "/admin/seo", label: "SEO Ops", icon: Gauge },
