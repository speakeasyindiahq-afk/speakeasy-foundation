...
export const Route = createFileRoute("/audio")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://speakeasyindia.online/audio" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Sunke Seekho — Audio lessons | Speakeasy India" },
      { name: "twitter:description", content: "Private, low-bandwidth audio lessons on sexual wellness in Hindi and English." },
    ],
    links: [{ rel: "canonical", href: "https://speakeasyindia.online/audio" }],
  }),
