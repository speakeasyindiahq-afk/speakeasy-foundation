...
export const Route = createFileRoute("/learn")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://speakeasyindia.online/learn" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Learn — Speakeasy India" },
      { name: "twitter:description", content: "Medically-reviewed sexual health lessons across 8 essential topics." },
    ],
    links: [{ rel: "canonical", href: "https://speakeasyindia.online/learn" }],
  }),
