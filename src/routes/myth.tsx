...
export const Route = createFileRoute("/myth")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://speakeasyindia.online/myth" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Myth Ya Sach? — Speakeasy India" },
      { name: "twitter:description", content: "Common sexual wellness myths corrected by clinicians. Hindi + English." },
    ],
    links: [{ rel: "canonical", href: "https://speakeasyindia.online/myth" }],
  }),
